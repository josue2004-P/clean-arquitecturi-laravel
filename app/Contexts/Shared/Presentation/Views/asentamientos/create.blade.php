            ...
            >
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1.5">
                            <x-shared::form.text-input id="codigo_postal" type="text" wire:model="codigo_postal" placeholder="ej: 91700" class="w-full font-mono font-bold text-indigo-600 dark:text-indigo-400" />
                        </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="mt-1.5">
                            <x-shared::form.text-input id="nombre_asentamiento" type="text" wire:model="nombre_asentamiento" placeholder="ej: Centro" class="w-full font-medium" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1.5">
                            <x-shared::form.text-input id="tipo_asentamiento" type="text" wire:model="tipo_asentamiento" placeholder="ej: Colonia, Fraccionamiento" class="w-full font-medium" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1.5">
                            <x-shared::form.text-input id="municipio" type="text" wire:model="municipio" placeholder="ej: Veracruz" class="w-full font-medium" />
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1.5">
                            <x-shared::form.text-input id="ciudad" type="text" wire:model="ciudad" placeholder="ej: Veracruz" class="w-full font-medium" />
                        </div>
                    ...
                    <div class="md:col-span-3">
                        ...
                        <div class="mt-1.5">
                            <x-shared::form.text-input id="estado" type="text" wire:model="estado" placeholder="ej: Veracruz de Ignacio de la Llave" class="w-full font-medium" />
                        </div>
