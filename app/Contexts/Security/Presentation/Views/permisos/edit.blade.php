    ...
    <div class="mb-8 flex items-center gap-4">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">
                Editing clave: <span class="font-mono font-bold text-indigo-600 dark:text-indigo-400">{{ $nombre }}</span>
            </p>
        </div>
    </div>

    <form wire:submit="save">
        <x-shared::common.component-card title="Configuración de la Llave" desc="Asegúrate de que la clave editada coincida con las directivas @can o Middleware en tu código." class="shadow-theme-md">
