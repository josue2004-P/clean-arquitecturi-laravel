...
<div class="max-w-4xl mx-auto">
    ...
    <form wire:submit="save">
        <x-shared::common.component-card title="Definición de Permiso" desc="Estas llaves son utilizadas por el Middleware para restringir accesos." class="shadow-theme-md">
