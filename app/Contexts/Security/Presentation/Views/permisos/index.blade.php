            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800 bg-transparent">
                    @forelse($permisos as $permiso)
                        <tr class="group hover:bg-indigo-50/30 dark:hover:bg-indigo-500/5 transition-all duration-200" wire:key="permiso-{{ $permiso['id'] }}">
                            ...
                            <td class="px-6 py-4 text-center whitespace-nowrap z-30">
                                <div x-data="{ 
                                    ...
                                    toggle(e) {
                                        ...
                                        if (this.dropdownOpen) {
                                            ...
                                            this.position.left = rect.right - 208 + window.scrollX; // W-52 = 208px
                                        }
                                    }
                                }" 
                                class="inline-block text-left">
                                    ...
                                    <template x-teleport="body">
                                        ...
                                        >
                                            <div class="px-3 py-2 text-[10px] font-bold text-gray-400 uppercase tracking-widest border-b border-gray-100 dark:border-gray-800 mb-1.5 text-left">
