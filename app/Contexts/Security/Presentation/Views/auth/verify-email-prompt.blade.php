<div>
    ...
    <x-slot:descripcionCard>¡Gracias por registrarte en el sistema del Laboratorio!</x-slot:descripcionCard>
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2 border-t border-gray-100 dark:border-gray-800">
            <form method="POST" action="{{ route('verification.send') }}" class="w-full sm:w-auto">
                @csrf
                <x-form.button-primary type="submit" class="w-full sm:w-auto justify-center shadow-lg shadow-indigo-500/10">
