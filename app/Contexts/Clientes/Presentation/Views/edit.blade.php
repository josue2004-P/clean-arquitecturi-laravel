                    ...
                    <div class="md:col-span-3 pt-6 mt-4 border-t border-dashed border-gray-200 dark:border-gray-800">
                        ...
                        <div class="space-y-4">
                            @foreach($telefonos as $index => $item)
                                <div class="grid grid-cols-1 md:grid-cols-12 gap-4 p-4 border border-gray-200 dark:border-gray-800 bg-gray-50/30 dark:bg-gray-900/10 relative rounded-none" wire:key="telefono-row-{{ $index }}">
                                    
                                    {{-- Input oculto para conservar el ID si ya existe en base de datos --}}
